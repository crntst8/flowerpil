...
/**
 * Cloudflare Pages Function for /api/* routes (catch-all)
 * Proxies all API requests to the backend origin
 * More specific Functions like /api/v1/[[path]].js take precedence over this
 */
